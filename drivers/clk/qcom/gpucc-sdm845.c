...
static const struct clk_parent_data gpu_cc_parent_data_2[] = {
	{ .fw_name = "bi_tcxo", .name = "bi_tcxo" },
	{ .fw_name = "crc_div", .name = "crc_div" },
	{ .fw_name = "gpu_cc_pll0_out_odd", .name = "gpu_cc_pll0_out_odd"  },
	{ .fw_name = "gpu_cc_pll1_out_even", .name = "gpu_cc_pll1_out_even"  },
	{ .fw_name = "gpu_cc_pll1_out_odd", .name = "gpu_cc_pll1_out_odd"  },
	{ .fw_name = "gcc_gpu_gpll0_clk_src", .name = "gcc_gpu_gpll0_clk_src"  },
	{ .fw_name = "core_bi_pll_test_se", .name = "core_bi_pll_test_se" },
};
...
static void gpu_cc_sdm845_fixup_sdm845v2(struct regmap *regmap)
{
	...
	gpu_cc_gmu_clk_src.clkr.vdd_data.rate_max[VDD_CX_LOW] = 500000000;
}
