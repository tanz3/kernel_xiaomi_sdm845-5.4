...
#define PSY_IIO_COLD_TEMP		0x88
#define PSY_IIO_COOL_TEMP		0x89
#define PSY_IIO_WARM_TEMP		0x8a
#define PSY_IIO_FG_RESET_CLOCK		0x8b
#define PSY_IIO_CHARGE_QNOVO_ENABLE		0x8c
